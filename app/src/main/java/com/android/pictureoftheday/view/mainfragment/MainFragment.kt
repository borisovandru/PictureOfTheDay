package com.android.pictureoftheday.view.mainfragment
...
import com.android.pictureoftheday.util.Constant
import com.android.pictureoftheday.util.Constant.MEDIA_TYPE_IMAGE
import com.android.pictureoftheday.util.Constant.WIKI_URL
import com.android.pictureoftheday.viewmodel.mainfragment.MainFragmentViewModel
import com.android.pictureoftheday.util.OnSwipeTouchListener
    ...
    private fun renderData(data: AppState) {
        when (data) {
            is AppState.SuccessAPOD -> {
                val serverResponseData = data.model
